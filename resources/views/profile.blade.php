...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><Center><strong>Profile</strong></Center></div>
                            ...
                            <div class="card-body"></div>
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="cardholder_name" type="text" class="form-control{{ $errors->has('cardholder_name') ? ' is-invalid' : '' }}" name="cardholder_name" value="{{ old('cardholder_name') }}" required autofocus>
